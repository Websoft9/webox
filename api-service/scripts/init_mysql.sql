...
CREATE TABLE IF NOT EXISTS `servers` (
    ...
    `status` ENUM('UNKNOWN', 'RUNNING', 'STOPPED') NOT NULL DEFAULT 'UNKNOWN' COMMENT 'Server status',
...
CREATE TABLE IF NOT EXISTS `server_agents` (
    ...
    `agent_ip` VARCHAR(45) NULL COMMENT 'Client IP',
    `agent_port` INT NOT NULL DEFAULT 22 COMMENT 'Client port',
    `version` VARCHAR(32) NULL COMMENT 'Client version',
    `status` ENUM('UNKNOWN', 'ONLINE', 'OFFLINE') NOT NULL DEFAULT 'UNKNOWN' COMMENT 'Client status',
    `last_heartbeat_at` DATETIME NULL COMMENT 'Last heartbeat time',
    `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation time',
    `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Update time',
    PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Client agents table';
...
CREATE TABLE IF NOT EXISTS `alert_rules` (
    ...
    `notification_channels` JSON NULL COMMENT 'Notification channels',
