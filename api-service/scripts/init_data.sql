...
INSERT INTO `permissions` (`parent_code`,`scope`,`name`,`code`,`module`,`action`,`resource`,`element`,`description`,`is_system`,`is_menu`,`sort_order`,`status`,`created_by`,`updated_by`) VALUES
   ...
   ('89f7e8d6-5c2a-4b1e-9f3d-1a2b3c4d5e6f','platform','ui.action_query','a1b2c3d4-e5f6-4789-a012-3456789abcde','secret_key','query','/secret-keys',NULL,'Secret key list query permission',1,0,0,1,1,1),
   ('89f7e8d6-5c2a-4b1e-9f3d-1a2b3c4d5e6f','platform','ui.action_create','b2c3d4e5-f6a7-4890-b123-456789abcdef','secret_key','create','/secret-keys',NULL,'Secret key create permission',1,0,0,1,1,1),
   ('89f7e8d6-5c2a-4b1e-9f3d-1a2b3c4d5e6f','platform','ui.action_query','c3d4e5f6-a7b8-4901-c234-56789abcdef0','secret_key','query','/secret-keys/*',NULL,'Secret key detail query permission',1,0,0,1,1,1),
   ('89f7e8d6-5c2a-4b1e-9f3d-1a2b3c4d5e6f','platform','ui.action_update','d4e5f6a7-b8c9-4012-d345-6789abcdef01','secret_key','update','/secret-keys/*',NULL,'Secret key update permission',1,0,0,1,1,1),
   ('89f7e8d6-5c2a-4b1e-9f3d-1a2b3c4d5e6f','platform','ui.action_delete','e5f6a7b8-c9d0-4123-e456-789abcdef012','secret_key','delete','/secret-keys/*',NULL,'Secret key delete permission',1,0,0,1,1,1),
   ('89f7e8d6-5c2a-4b1e-9f3d-1a2b3c4d5e6f','platform','ui.action_query','f6a7b8c9-d0e1-4234-f567-89abcdef0123','secret_key','query','/secret-keys/export',NULL,'Secret key export permission',1,0,0,1,1,1),
   ('89f7e8d6-5c2a-4b1e-9f3d-1a2b3c4d5e6f','platform','ui.action_query','a7b8c9d0-e1f2-4345-a678-9abcdef01234','secret_key','query','/secret-keys/*/value',NULL,'Secret key value decrypt permission',1,0,0,1,1,1),
   ('89f7e8d6-5c2a-4b1e-9f3d-1a2b3c4d5e6f','platform','ui.action_create','b8c9d0e1-f2a3-4456-b789-abcdef012345','secret_key','create','/secret-keys/files/upload',NULL,'Secret key file upload permission',1,0,0,1,1,1),
   ('89f7e8d6-5c2a-4b1e-9f3d-1a2b3c4d5e6f','platform','ui.action_query','c9d0e1f2-a3b4-4567-c890-bcdef0123456','secret_key','query','/secret-keys/files/download',NULL,'Secret key file download permission',1,0,0,1,1,1),
   ('89f7e8d6-5c2a-4b1e-9f3d-1a2b3c4d5e6f','platform','ui.action_delete','d0e1f2a3-b4c5-4678-d901-cdef01234567','secret_key','delete','/secret-keys/files/delete',NULL,'Secret key file delete permission',1,0,0,1,1,1);
...
INSERT INTO `role_permissions` (`role_id`,`permission_code`,`granted_by`,`status`) VALUES
         ...
         (1, 'b8c9d0e1-f2a3-4456-b789-abcdef012345',1,1),
         (1, 'c9d0e1f2-a3b4-4567-c890-bcdef0123456',1,1),
         (1, 'd0e1f2a3-b4c5-4678-d901-cdef01234567',1,1);
