    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.NotificationTemplateListResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/notifications/templates/{id}/preview": {
            "get": {
                ...
                "description": "Preview rendered notification template with sample data",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.NotificationTemplatePreviewResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.NotificationTemplateTestResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "request.CreateNotificationTemplateRequest": {
            ...
            "properties": {
                "content": {
                    "type": "string",
                    "example": "Dear user, your application {{app_name}} has been successfully deployed on {{deploy_time}}"
                },
                "name": {
                    "type": "string",
                    "maxLength": 64,
                    "minLength": 2,
                    "example": "Application Deployment Success Notification"
                },
                "subject": {
                    "type": "string",
                    "maxLength": 255,
                    "example": "Application {{app_name}} Deployment Successful"
                },
                "template_type": {
                    "type": "string",
                    "enum": [
        ...
        "response.NotificationTemplatePreviewResponse": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string"
