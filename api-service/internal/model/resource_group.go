...
type ResourceGroup struct {
	...
	ProjectID   uint      `gorm:"type:bigint unsigned;not null;column:project_id;index:idx_group_project_id;comment:Project ID" json:"project_id"` // Project ID
	...
	OwnerID     uint      `gorm:"type:bigint unsigned;not null;column:owner_id;index:idx_rs_owner_id;comment:Owner ID" json:"owner_id"`            // Resource group owner ID
