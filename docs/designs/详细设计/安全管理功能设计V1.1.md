...
- [Websoft9 功能详细设计说明书 V1.1](#websoft9-功能详细设计说明书-v11)
  ...
  - [5. 附录](#5-附录)
    - [5.1 action 操作权限定义](#51-action-操作权限定义)
    - [5.2 module 模块名称定义](#52-module-模块名称定义)
    - [5.3 认证参数配置文件](#53-认证参数配置文件)
