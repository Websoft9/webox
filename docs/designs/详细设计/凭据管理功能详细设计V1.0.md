...
| 方法   | 路径                            | 说明         | 认证       |
| ------ | ------------------------------- | ------------ | ---------- |
| POST   | `/api/v1/credentials`           | 创建凭据     | JWT + RBAC |
| PUT    | `/api/v1/credentials/:id`       | 修改凭据     | JWT + RBAC |
| GET    | `/api/v1/credentials`           | 凭据列表查询 | JWT + RBAC |
| GET    | `/api/v1/credentials/:id`       | 凭据详情查询 | JWT + RBAC |
| DELETE | `/api/v1/credentials/:id`       | 删除凭据     | JWT + RBAC |
...
- **概要**：修改已有凭据的信息
- **方法/路径**：PUT /api/v1/credentials/:id
- **请求参数**：
...
- **方法/路径**：GET /api/v1/credentials/:id
- **请求参数**：无
- **响应示例**：
...
- **概要**：删除指定的凭据
- **方法/路径**：DELETE /api/v1/credentials/:id
- **请求参数**：无
- **响应示例**：
