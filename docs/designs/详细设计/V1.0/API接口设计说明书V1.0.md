...
- [Websoft9 API接口设计说明书 V1.0](#websoft9-api接口设计说明书-v10)
  - [1. 引言](#1-引言)
  - [2. API设计原则](#2-api设计原则)
  ...
  - [4. 接口详细设计](#4-接口详细设计)
    - [4.1 监控面板](#41-监控面板)
      - [4.1.1 全局概览](#411-全局概览)
      - [4.1.2 应用监控面板](#412-应用监控面板)
      - [4.1.3 服务器监控面板](#413-服务器监控面板)
    - [4.2 应用商店](#42-应用商店)
      - [4.2.1 应用快捷导航](#421-应用快捷导航)
      - [4.2.2 应用商店列表](#422-应用商店列表)
        - [应用分类目录](#应用分类目录)
        - [应用列表](#应用列表)
      - [4.2.3 应用部署](#423-应用部署)
      - [4.2.4 应用心愿单](#424-应用心愿单)
      - [4.2.6 用户收藏和评价](#426-用户收藏和评价)
    - [4.3 工作空间](#43-工作空间)
      - [4.3.1 我的空间](#431-我的空间)
    ...
    - [4.4 资源管理](#44-资源管理)
      - [4.4.1 资源看板](#441-资源看板)
      - [4.4.2 应用管理](#442-应用管理)
      - [4.4.3 服务器管理](#443-服务器管理)
      - [4.4.4 数据库管理](#444-数据库管理)
    - [4.5 安全管控](#45-安全管控)
      - [4.5.1 应用网关](#451-应用网关)
      - [4.5.2 证书管理](#452-证书管理)
      - [4.5.3 审计日志](#453-审计日志)
